<?php 
    ...
    class Produk{
        ...
        //setter
        public function setjudul($judul){ //perlu parameter
            $this->judul = $judul;
        }
        public function setPenulis($penulis){ //perlu parameter
            $this->penulis = $penulis;
        }
        public function setPenerbit($penerbit){ //perlu parameter
            $this->penerbit = $penerbit;
        }
        public function setHarga($harga){ //perlu parameter
            $this->harga = $harga;
        }
